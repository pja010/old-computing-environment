...
beautiful.init("/home/per/.config/awesome/theme.lua")
...
-- Set the default gap (in pixels)
beautiful.useless_gap = 8

-- Then you can modify the gap for specific layouts (if desired)
awful.layout.suit.tile.useless_gap = 10
awful.layout.suit.tile.left.useless_gap = 10
awful.layout.suit.tile.bottom.useless_gap = 10
awful.layout.suit.tile.top.useless_gap = 10
...
globalkeys = gears.table.join(
    ...
    -- Brightness
    awful.key({}, "XF86MonBrightnessUp", function () os.execute("sudo brightnessctl set +10%") end,
